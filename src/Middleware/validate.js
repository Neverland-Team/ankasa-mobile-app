...
const updateProfileValidationRules = () => {
    return [
        ...
        .not().isEmpty().withMessage("email canot be empty")
        .custom(value => {
        ...
        body("username").not().isEmpty().withMessage("username canot be empty")
        .isAlphanumeric().withMessage("username must be alpha numeric")
        .custom(value => {
        ...
        body("post_code").not().isEmpty().withMessage("postal code cannot be empty")
        .isPostalCode(["ID"]).withMessage("postal code is not valid")
    ]
}
