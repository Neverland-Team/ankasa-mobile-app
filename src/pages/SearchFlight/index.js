...
export default function SearchFlight({navigation}) {
  const GetDateNow = (date) => {
    ...
    let dated = date.getDate(); //Current Date
  ...
  const [dates, setDates] = React.useState(GetDateNow(new Date()));
  const [child, setChild] = React.useState('Child');
  const [adult, setAdult] = React.useState('Adult');
    ...
    <>
      ...
      <View style={{backgroundColor: '#ffffff', flex: 1}}>
        <View style={styles.container}>
          ...
          <View style={styles.cardDestination}>
            ...
            <View>
              ...
              <Text style={styles.lightText}>Japan</Text>
            </View>
          </View>
          <Gap height={40} />
        ...
        <TouchableOpacity
          ...
          <Text style={[styles.btnTitle(false), {color: '#000'}]}>{dates}</Text>
          <IcArrowRightBlue />
        </TouchableOpacity>
        <Gap height={10} />
